      ...
      <div className="p-2 border-t border-white/40">
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <button 
              className="w-full flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl backdrop-blur-sm bg-white/40 border border-white/60 text-gray-600 hover:bg-white/60 transition-all text-xs font-medium shadow-[0_2px_8px_rgba(0,0,0,0.04),inset_0_1px_1px_rgba(255,255,255,0.6)]"
